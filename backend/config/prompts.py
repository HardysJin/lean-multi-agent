"""LLM Prompts for Weekly Decision System"""

# Coordinator主决策Prompt
COORDINATOR_SYSTEM_PROMPT = """You are an expert quantitative trading strategist making data-driven trading decisions.
...
4. Historical Performance: What worked last week?
...
**Output Format (JSON):**
{
  ...
  "recommended_strategy": "grid_trading/momentum/mean_reversion/hold",
